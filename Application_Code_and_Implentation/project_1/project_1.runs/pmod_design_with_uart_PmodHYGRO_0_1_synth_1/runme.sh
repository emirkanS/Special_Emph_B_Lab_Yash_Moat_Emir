...
HD_PWD='C:/Users/a/Desktop/MoatazProject/project_1/project_1.runs/pmod_design_with_uart_PmodHYGRO_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_design_with_uart_PmodHYGRO_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_design_with_uart_PmodHYGRO_0_1.tcl
