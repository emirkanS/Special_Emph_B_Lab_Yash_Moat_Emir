...
HD_PWD='D:/Emphasis_B/Labs/Lab_4/Lab_4_Exercise_1/Lab_4_Exercise_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_design_with_uart_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_design_with_uart_wrapper.tcl -notrace
