...
HD_PWD='D:/Emphasis_B/project_1/project_1.runs/pmod_design_with_uart_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_design_with_uart_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_design_with_uart_axi_uartlite_0_0.tcl
