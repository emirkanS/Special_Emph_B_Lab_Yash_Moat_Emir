...
HD_PWD='D:/Emphasis_B/Labs/Lab_5/Lab_5_Exercise_1/Lab_5_Exercise_1.runs/pmod_design_with_uart_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_design_with_uart_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_design_with_uart_dlmb_bram_if_cntlr_0.tcl
