...
HD_PWD='D:/Emphasis_B/Labs/Lab_5/Lab_5_Exercise_2/Lab_5_Exercise_2.runs/pmod_design_with_uart_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_design_with_uart_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_design_with_uart_axi_gpio_0_2.tcl
